...
void main() {
  ...
  testWidgets("Editing shows values", (tester) async {
    ...
    expect(
      find.descendant(
        of: find.widgetWithText(Row, "Çeken"),
  ...
  testWidgets("Editing updates controller", (tester) async {
    ...
    await tapAndSettle(tester, find.text("Gelgit"));
    await tapAndSettle(tester, find.text("Yüksek"));

    await tapAndSettle(tester, find.text("İlk Alçak Gelgit Saati"));
    ...
    await tapAndSettle(tester, find.text("İlk Yüksek Gelgit Saati"));
    await pickTimeAndSettle(
      tester,
      oldHour: "1",
      oldMinute: "00",
    ...
    await tapAndSettle(tester, find.text("İkinci Alçak Gelgit Saati"));
    await pickTimeAndSettle(
      tester,
      oldHour: "4",
      oldMinute: "00",
    ...
    await tapAndSettle(tester, find.text("İkinci Yüksek Gelgit Saati"));
    await pickTimeAndSettle(
      tester,
      oldHour: "1",
      oldMinute: "00",
