      ...
      "content": [
        {
          ...
          "value": format(PropertiesManager.get.feedbackTemplate, [
            appVersion,
            isNotEmpty(osVersion) ? osVersion : "Bilinmiyor",
            isNotEmpty(deviceModel) ? deviceModel : "Bilinmiyor",
            isNotEmpty(deviceId) ? deviceId : "Bilinmiyor",
            WidgetsBinding.instance.platformDispatcher.locale,
            userId,
            SubscriptionManager.get.isPro ? "Pro" : "Ücretsiz",
            type,
            _error ? widget.error : "Yok",
            isNotEmpty(widget.errorDetails) ? widget.errorDetails : "Yok",
            isNotEmpty(name) ? name : "Bilinmiyor",
            isNotEmpty(email) ? email : "Bilinmiyor",
            "${isNotEmpty(message) ? message : "Yok"}\n\n",
          ]),
        },
      ],
    };
